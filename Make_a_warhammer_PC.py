...
if __name__ == '__main__':
    ...
    print(abScore)
    print()
    print('CHARACTER CREATION SUMMARY [steps 1 to 3 were done for you]')
    print('1) Species: Page 24')
    print('2) Class and Career: Page 30')
    print('3) Attributes: Page 33')
    print('4) Skills and Talents: Page 35')
    print('5) Trappings: Page 37')
    print('6) Adding Detail: Page 37')
    print('7) Party : Page 41')
    print('8) Bringing Your Character To Life: Page 42')
    print('9) Advancement: Page 43')
